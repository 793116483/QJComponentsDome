//
//  UINavigationBar+PPStatusCategory.m
//  PatPat
//
...
#import "UINavigationBar+PPStatusCategory.h"

@implementation UINavigationBar (PPStatusCategory)

-(void)resetViewAndSubViewSkin {
    if(!self.isCustomNavigationBar){
        self.isCustomNavigationBar = YES;
    }
...
-(PPSkinStatusStyle)skinStatusStyle {
    UIBarStyle navigationBarStyle = [PPStatusStackManager shareManager].currentStatusSetModel.navigationBarStyle;
    
    return navigationBarStyle == UIBarStyleBlack ? PPSkinStatusStyleDark : PPSkinStatusStyleLight;
}
